...
function isTouching(man,money){
  if (man.x - money.x <= man.width/2 + money.width/2 &&  
    money.x - man.x <= man.width/2 + money.width/2 &&
    man.y - money.y <= man.height/2 + money.height/2 &&  
    money.y - man.y <= man.height/2 + money.height/2 ){
